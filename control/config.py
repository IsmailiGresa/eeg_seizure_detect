...
parser.add_argument('--activation', help='activation function of the networks', choices=['selu', 'relu'],default='relu', type=str)
...
parser.add_argument('--model', type=str, default="cnn2d_lstm_v1")
parser.add_argument('--hyperopt-model-name', type=str, default="xgboost_classification")
