...
parser.add_argument('--activation', help='activation function of the networks', choices=['selu', 'relu'],
                    default='relu', type=str)  # invase
parser.add_argument('--optim', type=str, default='adam',
                    choices=['sgd', 'sgd_lars', 'adam', 'adam_lars', 'adamw', 'adamw_lars'])
...
parser.add_argument('--gamma', '-gam', type=float, default=0.5,
                    help='T_up (warm up epochs) of cosine annealing scheduler')
...
parser.add_argument('--task-type', '-tt', type=str, default='binary',
                    choices=['anomaly', 'multiclassification', 'binary', 'binary_noslice'])
...
if args.task_type == "anomaly":
    ...
    args.num_to_seizure = {'0': 'patient_nor', '1': 'non_patient_nor', '2': 'gnsz', '3': 'fnsz', '4': 'spsz',
                           '5': 'cpsz', '6': 'absz', '7': 'tnsz', '8': 'tcsz', '9': 'mysz'}
    ...
    args.num_to_seizure = {'0': 'gnsz', '1': 'fnsz', '2': 'spsz', '3': 'cpsz', '4': 'absz', '5': 'tnsz', '6': 'tcsz',
                           '7': 'mysz'}
    ...
    args.seizure_to_num_inv = {'1': 'gnsz', '2': 'fnsz', '3': 'spsz', '4': 'cpsz', '5': 'absz', '6': 'tnsz',
                               '7': 'tcsz'}

    if args.binary_target_groups == 1:
        args.label_group = "LABEL1"
        args.output_dim = 8
        args.num_to_seizure = {'1': 'gnsz', '2': 'fnsz', '3': 'spsz', '4': 'cpsz', '5': 'absz', '6': 'tnsz',
                               '7': 'tcsz'}
